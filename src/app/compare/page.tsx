              ...
              <table className="w-full text-sm border-separate border-spacing-0 min-w-[480px]">
                <thead>
                  <tr className="text-left text-xs text-muted uppercase tracking-wider">
                    <th className="px-3 py-2 sticky left-0 bg-card border-b border-border whitespace-nowrap">Stat</th>
                    {selectedProfiles.map((p, i) => (
                      <th key={p.name} className="px-3 py-2 border-b border-border whitespace-nowrap" style={{ color: COLORS[i] }}>{parseDisambiguatedName(p.name).displayName}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={label as string} className="hover:bg-card-hover transition-colors group">
                      <td className="px-3 py-2 text-muted sticky left-0 bg-card group-hover:bg-card-hover border-b border-border/50 whitespace-nowrap">{label as string}</td>
                      {selectedProfiles.map(p => (
                        <td key={p.name} className="px-3 py-2 font-mono border-b border-border/50 whitespace-nowrap">
